...
public class FindingAllGenes {
        ...
        public static void main(String[] args) {
            ...
            System.out.println(">>>> FindingAllGenes <<<<");
            System.out.println(">>>> FindingAllGenes <<<<");
            ...
            System.out.println("");            
            sore = FindingAllGenes.findProtein("ATGTATGTAA");
            FindingAllGenes.printGensInformation(sore);
            //FindingAllGenes.countCTGCodon(fr.asString());
        }
...
//                    System.out.println("C-G Gen: " + word);
        ...
        public static StorageResource findProtein(String dna) {
            ...
            while (true) {
                ...
                if (geneCnt < 10) {
//                    System.out.println("GeneS#[" + start + "]: " + "GeneS#[" + endPos + "]");
//                    System.out.println("Gene #[" + geneCnt + "]: " + dna.substring(start, endPos));
                }
                geneCnt++;
